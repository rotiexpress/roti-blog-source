...
layout: post
current: post
cover:  assets/images/AES_background.png
navigation: True
...
###  Feedbacks ! ###
<img src="assets/images/aes_results.png" target="blank" alt="drawing" width="90%"/>
...
2. Pour répondre : pas d'application à télécharger, pas d'inscription fastidieuse (login/mot de passe).
...
5. Nous avons expliqué que les résultats finaux seraient partagés avec tout le monde.

6. Une prise de feedback ROTI (en mode Agile) était très adaptée à cet évènement !
